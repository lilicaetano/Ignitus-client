...
import { interfaceBlockedUsers } from '../../ignitus-UserInterfaceBook/Components/Organisms/interfaceBlockedUsers/Components';
  ...
  <Container>
    ...
    <LeftRow>
      <Switch>
        ...
        <Route
          path="/interface/blockedUsers"
          component={interfaceBlockedUsers}
        />
      </Switch>
    </LeftRow>
  </Container>
